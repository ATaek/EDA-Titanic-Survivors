...
bind_predictions <- bind_cols(pred_log_fit <-predict(log_fit,new_data = titanic_train, type = 'prob'),
pre_lda_fit <-predict(lda_fit,new_data = titanic_train, type = 'prob'),
pred_qda_fit <-predict(qda_fit,new_data = titanic_train, type = 'prob'),
pred_nb_fit <-predict(nb_fit,new_data = titanic_train, type = 'prob'))
```
```{r}
bind_predictions
```
